    ...
    return (
        <div align="center">
            ...
            <div className="flex flex-col sm:flex-row max-w-8xl justify-between items-center py-8 w-11/12 sm:w-10/12 mx-auto">
                ...
                <h1 className="font-sans text-white text-base flex items-center gap-1 mt-2 sm:mt-0">{(user == null) ? (<div className="w-3 h-3 rounded-full bg-red-600"/>) : (<div className="w-3 h-3 rounded-full bg-green-600"/>)}<SiVercel size="20px" color="WHITE"/> Vercel & <img src="https://storage.googleapis.com/lanyard/static/lanyardtemplogo.png" className="w-24 h-8"/></h1>
